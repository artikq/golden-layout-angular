...
export const GoldenLayoutStateStore = new InjectionToken(
...
export const DEFAULT_LOCAL_STORAGE_STATE_STORE = new LocalStorageStateStore(
  DEFAULT_LOCAL_STORAGE_STATE_STORE_KEY
);
